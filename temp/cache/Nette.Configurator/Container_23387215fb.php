...
class Container_23387215fb extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\UmiestneniePresenter' => array(array('application.4')),
			'App\Presenters\ZamestnanecPresenter' => array(array('application.5')),
			'App\Presenters\ZivocichPresenter' => array(array('application.6')),
		...
		'services' => array(
			...
			'application.4' => 'App\Presenters\UmiestneniePresenter',
			'application.5' => 'App\Presenters\ZamestnanecPresenter',
			'application.6' => 'App\Presenters\ZivocichPresenter',
	...
	{
		return new Container_23387215fb_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_23387215fb_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_23387215fb $container)
	{
