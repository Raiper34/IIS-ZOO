<?php
// source: C:\Users\Raiper34\Desktop\server\root\nette\app\moduly/templates/Druh/vypis.latte

class Template64a1cfbb02027c7ff06bfa3924de75c2 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('429e7bdcbb', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbbc7bfee026_content')) { function _lbbc7bfee026_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
