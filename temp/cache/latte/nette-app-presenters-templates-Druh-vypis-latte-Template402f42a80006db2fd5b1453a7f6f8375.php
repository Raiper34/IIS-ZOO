<?php
// source: C:\Users\Raiper34\Desktop\server\root\nette\app\presenters/templates/Druh/vypis.latte

class Template402f42a80006db2fd5b1453a7f6f8375 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('93cb21e21f', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb1e8f9c1d71_content')) { function _lb1e8f9c1d71_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
