<?php
// source: C:\Users\Raiper34\Desktop\server\root\nette\app\mvc/templates/Uzivatelia/vypis.latte

class Templatea3d1b37a3bdf38657bc356e8e6647dbc extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6f8faf60c1', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb351f6da56b_content')) { function _lb351f6da56b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
