<?php
// source: C:\Users\Raiper34\Desktop\server\root\nette\app\moduly/templates/@layout.latte

class Template5f36b9862ab784c0beb5551fa7c94911 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b9d8c16dc2', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb2b14e62608_head')) { function _lb2b14e62608_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbc7c128940b_scripts')) { function _lbc7c128940b_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
